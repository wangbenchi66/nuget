...
namespace Easy.DynamicApi
{
    ...
    public static class DynamicWebApiServiceExtensions
    {
        ...
        /// <returns></returns>
        public static IServiceCollection AddDynamicApi(this IServiceCollection services, DynamicWebApiOptions options)
        {
            if (options == null)
            {
        ...
        {
            return AddDynamicApi(services, new DynamicWebApiOptions());
        }

        public static IServiceCollection AddDynamicApi(this IServiceCollection services, Action<DynamicWebApiOptions> optionsAction)
        {
            var dynamicWebApiOptions = new DynamicWebApiOptions();

            optionsAction?.Invoke(dynamicWebApiOptions);

            return AddDynamicApi(services, dynamicWebApiOptions);
        }
